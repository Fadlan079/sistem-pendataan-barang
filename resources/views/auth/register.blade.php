...
@section('title', 'Daftar - Sistem Pendataan Barang')
...
<div class="bg-bg text-text min-h-screen flex flex-col justify-between font-sans selection:bg-primary-accent/25 selection:text-primary">
    <main class="flex-1 max-w-6xl mx-auto px-6 py-12 md:py-16 flex items-center justify-center w-full">
        <div class="w-full max-w-md bg-white rounded-2xl border border-border/60 shadow-lg p-8 flex flex-col gap-6 relative overflow-hidden">
            ...
            <div class="relative z-10 text-center flex flex-col gap-2">
                <h2 class="text-2xl font-bold text-primary tracking-tight">Buat Akun Baru</h2>
                <p class="text-xs text-muted">Daftar untuk mengelola pendataan barang Anda secara terstruktur</p>
            </div>

            <form method="POST" action="{{ route('register') }}" class="relative z-10 flex flex-col gap-4">
                @csrf
                <div>
                    <label for="name" class="block font-semibold text-xs text-primary uppercase tracking-wide mb-1.5">Nama Lengkap</label>
                    <div class="relative flex items-center">
                        <i class="fa-solid fa-user absolute left-3.5 text-muted text-sm"></i>
                ...
                <div>
                    <label for="password_confirmation" class="block font-semibold text-xs text-primary uppercase tracking-wide mb-1.5">Konfirmasi Password</label>
                    <div class="relative flex items-center">
                        <i class="fa-solid fa-lock absolute left-3.5 text-muted text-sm"></i>
            ...
            <div class="relative z-10 text-center text-xs text-muted">
                Sudah memiliki akun?
                <a href="{{ route('login') }}" class="font-semibold text-secondary hover:text-secondary-light transition-colors">Masuk di sini</a>
            </div>
        </div>
    </main>
</div>
